...
const slides = [
...

  {
    ...
    title: (
      <p className="text-white">
        {" "}
        <span className="text-[#4eb2e5]"> Afro Fusion </span>— Defined for This
        Occasion. Afro Fusion refers to modern formal eveningwear subtly
        informed by African identity — through fabric choice, craftsmanship,
        texture, colour, or detail. The emphasis is on silhouette, polish, and
        elegance, not traditional ceremonial dress.
      </p>
    ),
    img: "/female1.jpeg",
    overlay: (
...

  {
    ...
    title: (
      <p className="text-white">
        <span className="text-[#4eb2e5]">It is a formal event.</span>{" "}
        Traditional garments such as iro & buba, agbada, regular kaftans,
        senator wear, and full ethnic regalia do not align with the aesthetic of
        this evening. African influence is welcomed — traditional silhouettes
        are not. Fabric choice is not limited to just ankara and aso-oke.
        Akwete, kente, Adire, Batik and others are also welcomed.",
      </p>
    ),
    img: "/male4.jpeg",
    overlay: (
